...
login berhasil	$actual_result=login('dipo',md5('dipo'));
...
public function unittest2(){
	require ('C:\xampp\htdocs\eLibrary\model\db.php');
login berhasil	$actual_result=login('hasrul',md5('hasrul'));
	$expected_result="Location:../pages/user/adm.php";
	$this->assertEquals($actual_result[0]->getUrl(),$expected_result);
...
public function unittest3(){
	require ('C:\xampp\htdocs\eLibrary\model\db.php');
login gagal	$actual_result=login('dipo',md5('dipa'));
...
public function unittest4(){
	require ('C:\xampp\htdocs\eLibrary\model\db.php');
login gagal	$actual_result=login('dipa',md5('dipo'));
